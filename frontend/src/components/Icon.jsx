/**
 * Inline SVG icon set (Lucide-style: 24px viewBox, 2px stroke, round caps).
 * Color follows `currentColor`, so icons inherit text color automatically.
 * Usage: <Icon name="users" /> · <Icon name="trash" size={16} /> · <Icon name="star" fill />
 */
